...
@property (nonatomic,strong) NSMutableArray *rememberForLaterArray;
@property (nonatomic,copy) NSMutableArray *arrayToCopyForLater;
@property (assign) CGFloat floatNumber;
